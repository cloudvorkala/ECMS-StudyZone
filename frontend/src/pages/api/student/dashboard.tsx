    ...
    <ProtectedRoute allowedRoles={['student']}>
      <div className="min-h-screen bg-gray-100 p-8 flex">
        ...
        <div className="w-1/3 p-4 space-y-4">
          ...
          <Link href="/student/groups" className="block p-4 bg-pink-100 rounded-lg hover:bg-pink-200">
            📚 Study Group
          </Link>
          <Link href="/student/study-room-booking" className="block p-4 bg-green-100 rounded-lg hover:bg-green-200">
            🏫 Meeting Room
          </Link>
        ...
        <div className="flex-1 bg-white p-6 rounded-xl shadow-md">
          ...
          <ul className="list-disc pl-5 text-sm text-gray-600 space-y-1">
            ...
            <li>📚 Join a study group or reserve a room for discussion</li>
          </ul>
